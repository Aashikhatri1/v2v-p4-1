...
def response_type(query, category, type_value, chat_history):
    ...
    if question_type == "FAQ":
        ...
        if general_talk == "Yes":
            chat_history = pplx_playht_final.final_answer('', chat_history, query)
        else:
        ...
        chat_history = pplx_playht_final.rooms_availability_final_answer(rooms_data, chat_history, query)
