    ...
    messages = [
        {
            ...
            "content": (
                """
                Create a json for information required from client based on the user query and chat history.
                Keep the value blank if a particular info is not provided.
                example: { "number of guests": 5, "check out date": "2023-03-15" }
                If user has given any information in previous part of conversation, include it in the json. Otherwise write "N/A".
                Always respond in json format {"info1": "<info provided>", "info2": "<info provided>", "info3": "<info provided>"}. Please keep your response short.
                Options: 
                """
                + f'Info: {str(info)}'
