        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    For room booking conversation, write 'user wants to book a room', not 'user booked a room'. Do not assume any information.'''
                ),
            }
        ]
                ...
                if 'Information Required From Client' in info_item:
                    ...
                    if value is not None and value != 'NA':
                        ...
                        if 'N/A' in chat_user_info.values():
                            ...
                            # if 'name' in chat_user_info and chat_user_info['name'] != 'N/A':
                            #     pla
